...
<link href="<%=request.getContextPath()%>/resources/css/main/lectoer/lectoer_plan.css" rel="stylesheet">
<!DOCTYPE html>
<html lang="kor">
...
<div class="body_wrap">
    <div class="syllabus_wrap">
        ...
        <div class="lectoer_plan_pagebtn">
            <button type="submit" onclick="location.href='/lectoer/plan'">강의계획</button>
            <button type="submit" onclick="location.href='/lectoer/weekplan'">주차별계획</button>
        </div>
        ...
        <div class="lectoer_plan_table3">
            <table>
                <tbody>
                    <tr><th>강의설명</th><td>블라블라</td></tr>
                    <tr><th>주교재</th><td>블라블라</td></tr>
                    <tr><th>비고</th><td>블라블라</td></tr>
                </tbody>
            </table>
        </div>
